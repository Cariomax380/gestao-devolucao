...
export interface ResumoDashboard {
  ...
  pdv_repasse: number
  vol_faturado: number
  vol_devolvido: number
  revertidas: number
}

export interface ResumoPorData {
  data_rota: string
  fat: number
  dev: number
  pct: number
...
export interface ResumoPorMotivo {
  motivo: string
  qtd: number
  pct: number
}

export interface ResumoPorMotorista {
  motorista: string
  fat: number
  dev: number
  pct: number
...
export interface ResumoPorClassificacao {
...
export interface MotivoDisponivel {
  motivo: string
}
